...
const Home1 = () => {
    return (
        <div className="flex flex-wrap gap-20 justify-center xl:mx-52">
            ...
            <Cards link='' title='Status Reports' image={status} />
            ...
            <Cards link='' title='Threats' image={threat} />
            <Cards link='' title='Incidents' image={incident}/>
            <Cards link='' title='Users' image={users} />
            <Cards link='' title='Support' image={support} />
            <Cards link='' title='Settings' image={setting} />
        </div>
    )
}
