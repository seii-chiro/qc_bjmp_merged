        ...
        <div className="mt-10">
            ...
            <form onSubmit={handleAffiliationTypeSubmit}>
                <div className="flex flex-col gap-5">
                        <input type="text" name="affiliation_type" id="affiliation_type" onChange={handleInputChange} placeholder="Affiliation Type" className="h-12 border border-gray-300 rounded-lg px-2" />
