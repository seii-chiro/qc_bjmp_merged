        ...
        <div className="mt-10">
            ...
            <form onSubmit={handleRankSubmit}>
                <div className="flex flex-col gap-5">
                    ...
                    />
                    <input type="text" name="rank_code" id="rank_code" onChange={handleInputChange} placeholder="Rank Code" className="h-12 border border-gray-300 rounded-lg px-2" />
                    <input type="text" name="rank_name" id="rank_name" onChange={handleInputChange} placeholder="Rank Name" className="h-12 border border-gray-300 rounded-lg px-2" />
                    <Select
                        className="h-[3rem] w-full"
                        showSearch
                    ...
                    />
                    <input type="text" name="class_level" id="class_level" onChange={handleInputChange} placeholder="Class Level" className="h-12 border border-gray-300 rounded-lg px-2" />
                </div>
