            ...
            <form onSubmit={handlejailTypeSubmit}>
                <div className="flex gap-5 w-full">
                    <div className="flex flex-col gap-2 flex-1">
                        <input type="text" name="type_name" id="type_name" onChange={handleInputChange} placeholder="Jail Type Name" className="h-12 border border-gray-300 rounded-lg px-2" />
