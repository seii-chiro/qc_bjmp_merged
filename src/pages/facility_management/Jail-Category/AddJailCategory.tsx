            ...
            <form onSubmit={handlejailTypeSubmit}>
                <div className="flex gap-5 w-full">
                    <div className="flex flex-col gap-2 flex-1">
                        <input type="text" name="category_name" id="category_name" onChange={handleInputChange} placeholder="Jail Category" className="h-12 border border-gray-300 rounded-lg px-2" />
