            ...
            <form onSubmit={handleplatformSubmit}>
                <div className="flex gap-5 w-full">
                    <div className="flex flex-col gap-2 flex-1">
                        <input type="text" name="platform_name" id="platform_name" onChange={handleInputChange} placeholder="Social Media Name" className="h-12 border border-gray-300 rounded-lg px-2" />
