        ...
        <div>
            ...
            <form onSubmit={handleAddressSubmit}>
                <div className="flex flex-col gap-5">
                    <input type="text" name="address_type" id="address_type" onChange={handleInputChange} placeholder="Address Type" className="h-12 border border-gray-300 rounded-lg px-2" />
