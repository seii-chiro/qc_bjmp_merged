        ...
        <div>
            ...
            <form onSubmit={handlePrefixSubmit}>
                <div className="flex flex-col gap-5">
                        <input type="text" name="prefix" id="prefix" onChange={handleInputChange} placeholder="Prefix" className="h-12 border border-gray-300 rounded-lg px-2" />
                        <input type="text" name="full_title" id="full_title" onChange={handleInputChange} placeholder="Full Title" className="h-12 border border-gray-300 rounded-lg px-2" />
