        ...
        <div className="mt-10">
            ...
            <form onSubmit={handleCellSubmit}>
                <div className="flex flex-col gap-5">
                    ...
                    />
                        <input type="text" name="cell_no" id="cell_no" onChange={handleInputChange} placeholder="Cell No." className="h-12 border border-gray-300 rounded-lg px-2" />
                        <input type="text" name="cell_name" id="cell_name" onChange={handleInputChange} placeholder="Cell Name" className="h-12 border border-gray-300 rounded-lg px-2" />
                        <input type="text" name="cell_description" id="cell_description" onChange={handleInputChange} placeholder="Cell Description" className="h-12 border border-gray-300 rounded-lg px-2" />
